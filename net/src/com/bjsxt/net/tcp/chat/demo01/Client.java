...
public class Client {
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			System.out.println("手写前"+new Date().getTime());
			String info = console.readLine(); 
			System.out.println("手写后"+new Date().getTime());
			//输出流
			System.out.println("客户端写socket前"+new Date().getTime());
			dos.writeUTF(info);
			dos.flush();
			System.out.println("客户端写socket后"+new Date().getTime());
			//输入流
